        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <h3 className="text-xl font-bold text-foreground">EnglishXpress</h3>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-muted-foreground">
                ...
                <span className="text-base">admin@englishxpress.com</span>
              </div>
              <div className="flex items-center gap-3 text-muted-foreground">
                <Phone className="w-4 h-4 text-primary" />
                <span className="text-base">+8801782521290</span>
              </div>
              <div className="flex items-center gap-3 text-muted-foreground">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#approach" className="text-muted-foreground hover:text-primary transition-colors text-base">Our Approach</a></li>
              <li><a href="#why-join" className="text-muted-foreground hover:text-primary transition-colors text-base">Why Join Us</a></li>
              <li><a href="#achievers" className="text-muted-foreground hover:text-primary transition-colors text-base">Success Stories</a></li>
              <li><a href="#faq" className="text-muted-foreground hover:text-primary transition-colors text-base">FAQ</a></li>
            </ul>
          </div>
        </div>
